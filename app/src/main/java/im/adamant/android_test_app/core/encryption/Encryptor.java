package im.adamant.android_test_app.core.encryption;
...
import im.adamant.android_test_app.core.exceptions.InvalidValueForKeyValueStorage;
...
public class Encryptor {
    ...
    public TransactionMessage encryptMessage(String message, String recipientPublicKey, String mySecretKey){
        ...
        try {
            ...
            String encryptedMessage = sodium.cryptoBoxEasy(message, nonceBytes, curve25519KeyPair);

            chat = new TransactionMessage();
            chat.setMessage(encryptedMessage.toLowerCase());
