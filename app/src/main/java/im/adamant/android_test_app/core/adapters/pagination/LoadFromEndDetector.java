package im.adamant.android_test_app.core.adapters.pagination;
...
class NestedLoadDetector extends LoadFromEndDetector {
    ...
    protected void onAttachedToRecyclerView(RecyclerView recyclerView, PaginationAdapter paginationAdapter) {
